...
!function webpackUniversalModuleDefinition(e, t) {
    ...
    var e = {
        ...
        5683: (e, t, r) => {
            "use strict";
            var n, i, o = r(1010), a = r(4723), s = o.process, u = o.Deno, c = s && s.versions || u && u.version, f = c && c.v8;
        ...
        1091: (e, t, r) => {
            ...
            e.exports = function(e, t) {
                var r, i, p, d, _, y, m, g, v, b = e.target, w = e.global, I = e.stat, x = e.proto, B = w ? n : I ? n[b] : n[b] && n[b].prototype, k = w ? c : c[b] || l(c, b, {})[b], C = k.prototype;
                for (d in t)
                    i = !(r = u(w ? d : b + (I ? "." : "#") + d, e.forced)) && B && h(B, d),
                    y = k[d],
                    i && (m = e.dontCallGetSet ? (v = s(B, d)) && v.value : B[d]),
                    _ = i && m ? m : t[d],
                    (r || x || typeof y != typeof _) && (g = e.bind && i ? f(_, n) : e.wrap && i ? wrapConstructor(_) : x && a(_) ? o(_) : _,
    ...
    return ( () => {
        ...
        var te = function makeSnippet(e, t) {
            ...
            for (s = 1; s <= t.linesBefore && !(a - s < 0); s++)
                ...
                c = J.repeat(" ", t.indent) + padStart((e.line - s + 1).toString(), f) + " | " + u.str + "\n" + c;
            for (u = getLine(e.buffer, i[a], o[a], e.position, l),
            c += J.repeat(" ", t.indent) + padStart((e.line + 1).toString(), f) + " | " + u.str + "\n",
        ...
        function mergeMappings(e, t, r, n) {
            var i, o, a, s;
            for (J.isObject(r) || throwError(e, "cannot merge mappings; the provided source object is unacceptable"),
            a = 0,
        ...
        const loaded = () => () => {}
          ...
          , getConfigByUrl = (e, t) => r => {
            ...
            if (e)
                return i.downloadConfig(e).then(next, next);
            function next(i) {
        ...
        const Ut = console.error
          ...
          , fallback = ({name: e}) => n.createElement("div", {
            className: "fallback"
